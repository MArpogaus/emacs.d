...
#+begin_src shell :var file_name="init.el" :results output
  ...
  ;; Copyright (C) 2010-$(date +%Y) Marcel Arpogaus
...
*** UI
:PROPERTIES:
:header-args: :tangle lisp/my-ui.el :mkdirp yes
:END:
#+begin_src emacs-lisp :tangle init.el
  (require 'my-ui)
#+end_src
...
*** UX
:PROPERTIES:
:header-args: :tangle lisp/my-ux.el :mkdirp yes
:END:
#+begin_src emacs-lisp :tangle init.el
  (require 'my-ux)
#+end_src
...
*** Org
:PROPERTIES:
:header-args: :tangle lisp/my-org.el :mkdirp yes
:END:
#+begin_src emacs-lisp :tangle init.el
  (require 'my-org)
#+end_src
...
*** Tools
:PROPERTIES:
:header-args: :tangle lisp/my-tools.el :mkdirp yes
:END:
#+begin_src emacs-lisp :tangle init.el
  (require 'my-tools)
#+end_src
...
*** Completion
:PROPERTIES:
:header-args: :tangle lisp/my-completion.el :mkdirp yes
:END:
#+begin_src emacs-lisp :tangle init.el
...
*** Version Control
:PROPERTIES:
:header-args: :tangle lisp/my-vc.el :mkdirp yes
:END:
#+begin_src emacs-lisp :tangle init.el
  (require 'my-vc)
#+end_src
...
*** Project Management
:PROPERTIES:
:header-args: :tangle lisp/my-project.el :mkdirp yes
:END:
#+begin_src emacs-lisp :tangle init.el
  (require 'my-project)
#+end_src
...
*** Programming
:PROPERTIES:
:header-args: :tangle lisp/my-programming.el :mkdirp yes
:END:
#+begin_src emacs-lisp :tangle init.el
...
#+begin_src emacs-lisp
  (use-package combobulate
    ...
    (:map combobulate-key-map
          ...
          ("S-<left>"  . combobulate-navigate-next)
          ("S-<right>" . combobulate-navigate-previous)
...
*** Keybindings
:PROPERTIES:
:header-args: :tangle lisp/my-keybindings.el :mkdirp yes
:END:
#+begin_src emacs-lisp :tangle init.el
