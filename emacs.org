...
- [[#configuration][Configuration]]
  ...
  - [[#early-emacs-initialization][Early Emacs Initialization]]
    ...
    - [[#default-frame-and-initial-frame-settings][Default Frame and initial Frame Settings]]
...
#+begin_src emacs-lisp
  (use-package conda
    ...
    (define-minor-mode my/conda-env-autoactivate-mode
  ...
  buffer."
      ...
      :global t
      ;; Forms
      (if my/conda-env-autoactivate-mode ;; already on, now switching off
          (progn
    ...
    (my/conda-env-autoactivate-mode)
    :config
...
#+begin_src emacs-lisp :tangle no
  (use-package repeat-help
    :straight (:host github :repo "LemonBreezes/repeat-help" :branch "real-last-command")
    :custom
