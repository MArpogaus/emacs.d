...
#+end_src
**** [[https://github.com/konrad1977/flyover.git][flyover]]
#+begin_src emacs-lisp :tangle no
  (use-package flyover
    :ensure (:host github :repo "konrad1977/flyover")
    :hook
    ((flymake-mode . flyover-mode)) ;; enable flyover when flycheck starts

    :custom
    ;; Which checkers to use
    (flyover-checkers '(flymake)) ;; or '(flycheck flymake)

    ;; Which error levels to display
    (flyover-levels '(error warning info))

    ;; Theme integration and coloring
    ...
    ;; Virtual line style
    (flyover-virtual-line-type 'curved-line-no-error)

    ;; Visibility and UI behavior
