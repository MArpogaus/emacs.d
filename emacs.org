...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package git-gutter-fringe+
    ...
    :hook
    (global-git-gutter+-mode . git-gutter-fr+-minimal))
#+END_SRC
...
#+begin_src emacs-lisp
  (use-package tab-bar
    ...
    ;; (defun my/tab-bar-tab-format-around (orig-fun tab i)
    ...
    ;;      )))
                                          ...
                                          ;(advice-add 'tab-bar-tab-group-format-default :around #'my/tab-bar-tab-format-around)

    (defun my/tab-bar-tab-name-around (orig-fun)
      (format " %s " (funcall orig-fun)))
    (advice-add 'tab-bar-tab-name-current :around #'my/tab-bar-tab-name-around)
